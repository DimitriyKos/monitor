...
def download_ozon_html(product_url: str, user_id: str):
    ...
    chromedriver_autoinstaller.install()  # автоматически подбирает версию под Chrome
...
def parse_html_file(filepath):
    ...
    product_name = h1_tag.get_text(strip=True) if h1_tag else os.path.basename(filepath).replace(".html", "")
